...
public interface VerleihService extends ObservableService
{
     ...
     * 
     * @param medium    Ein Medium
     * @param stelle    Stelle, die abgefragt wird
     * @return          Vormerker an Stelle stelle
     * 					null, wenn nicht vorhanden
     * 
     * @require medium != null
     */
    Kunde getVormerker(Medium medium, int stelle);

    /**
     * Merkt eine Liste von Medien für einen Kunden vor
     * 
     * @param kunde		Vormerker
     * @param medien	Vorzumerkende Medien
     * 
    ...
    /**
     * Überprüft, ob alle Medien einer Liste von einem bestimmten Kunden vorgemerkt werden können
     * 
     * @param kunde     Kunde, der die Medien vormerken will
     * @param medien    Medien, die vorgemerkt werden sollen
     * 
     * @require kunde != null
     * @require medien != null
     */
